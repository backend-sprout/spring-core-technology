...
`org.springframework.beans`및 `org.springframework.context`패키지에 존재하며        
`BeanFactory 인터페이스`라는 모든 유형의 객체를 관리 할 수있는 고급 구성 메커니즘을 제공합니다.    
ApplicationContext 의 하위 인터페이스입니다 BeanFactory. 다음을 추가합니다.    
